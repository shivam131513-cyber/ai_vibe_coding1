-- ============================================
-- FINAL FIX - Run this single script
...
-- Create tables (IF NOT EXISTS means no error if they exist)
...
-- Re-enable RLS (this will drop all existing policies)
ALTER TABLE public.users ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.reports ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.badges ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.user_badges ENABLE ROW LEVEL SECURITY;

-- Now create fresh policies (no conflicts because we disabled/enabled RLS)
